...
<span>If anything has to do with healthcare, I'm more likely to be interested in it because I enjoy helping others by making their lives simpler. Additionally, because I would like to work on ML-related projects, I have designated ML as my concentration at Penn State. </span>

<span>When I'm not working, I like to spend time with my family by chatting to them or going on trips. I'm always ready for an adventure and I love to travel the world.</span>
      </p>
    </motion.section>
  )
}
